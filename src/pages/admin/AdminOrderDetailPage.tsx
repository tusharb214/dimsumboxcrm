...
//                           <p className="font-medium text-white leading-tight">{item.materialName}</p>
//                           <p className="text-xs text-slate-500">
//                             {item.category || ''}{item.brand ? ` • ${item.brand}` : ''}
//                           </p>
//                         </td>
//                         <td className="px-2 py-2.5 text-center font-semibold text-white">x{item.quantity}</td>
//                         <td className="px-2 py-2.5 text-right text-slate-400">₹{item.priceAtOrder}</td>
          ...
          <div className="card px-5 py-4 space-y-3">
            ...
            <div className="pt-2 border-t border-slate-800">
              ...
              {order.screenshotPath ? (
                ...
                <p className="text-xs text-slate-500">User hasn't uploaded a screenshot yet.</p>
              )}
            </div>
