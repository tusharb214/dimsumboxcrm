      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-xl font-bold text-white flex items-center gap-2">
            <Wallet className="w-5 h-5 text-amber-400" /> Pending Payments
          </h1>
          <p className="text-slate-400 text-sm mt-0.5">{orders.length} orders awaiting payment confirmation</p>
        </div>
